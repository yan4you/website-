...
<head>
  ...
  <title>admin midguy steak house</title>

  <!-- icon -->
  <link rel="icon" href="/icon/setting.png">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light"> midguy steak house</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">yan4you</a>
        </div>
      </div>

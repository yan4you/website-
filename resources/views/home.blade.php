...
<head>
    ...
    <title> Restorant midguy steak house </title>
...
<body>
    ...
    <div class="hero_area">
        <div class="bg-box">
            <img src="images/hero-bg-3.jpeg" alt="">
        </div>
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav  mx-auto ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/servis">Book Table</a>
                            </li>
                        </ul>
            ...
            <div class="container ">
                <div class="row">
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="images/steak1.jpeg" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    wagyu ripay
                    ...
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="images/steak2.jpeg" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    wagyu sirloin
    ...
    <section class="food_section layout_padding-bottom">
        <div class="container">
            ...
            <ul class="filters_menu">
                ...
                <li data-filter=".burger">steak</li>
                ...
                <div class="row grid">
                    <div class="col-sm-6 col-lg-4 all pizza">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/steak4.jpeg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>
                                        steak sirloin
                    ...
                    <div class="col-sm-6 col-lg-4 all burger">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/steak5.jpeg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>
                                        wagyu A5 t-bone
                    ...
                    <div class="col-sm-6 col-lg-4 all pizza">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/steak6.jpeg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>
                                        wagyu A5 rib eye
                    ...
                    <div class="col-sm-6 col-lg-4 all pizza">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/steak7.jpeg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>
                                        wagyu A5 tenderloin
                    ...
                    <div class="col-sm-6 col-lg-4 all burger">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/steak8.jpeg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>
                                        wagyu A5 flank
                    ...
                    <div class="col-sm-6 col-lg-4 all burger">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/steak9.jpeg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>
                                        wagyu A5 Salisbury
